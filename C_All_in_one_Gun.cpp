...
void solve()
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                int req = hel[i].first + hel[i].second;
                if (m.lower_bound(req) != m.end())
                {
                    ans += i + 1;
                    cout << ans << endl;
                    return;
                }
                m.erase(m.find(a[i + 1]));
            }
            cout << ans + lastidx + 1 << endl;
        }
    }
}
