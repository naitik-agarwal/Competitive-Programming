...
void solve()
{
    ...
    if (countzero % 2 == 0)
    {
        cout << (countzero / 2) * (countzero / 2) << endl;
    }
    else
    {
        cout << ((countzero + 1) / 2) * (countzero / 2) << endl;
    }
    vector<int> zerovertical(m);
    for (int i = 0; i < m; i++)
    {
        int count = 0;
        for (int j = 0; j < n; j++)
        ...
        zerovertical[i] = count;
    }
    int required = countzero / 2; // we will use lower one
    if (required == 0)
    {
        for (int i = 0; i < m; i++)
        {
    ...
    for (int i = 0; i < reqy; i++)
    {
        cout << "R";
    }
    for (int i = 0; i <= reqx; i++)
    {
        cout << "D";
    }
    cout << "R";
    for (int i = 1; i <= n - reqx - 1; i++)
    {
        cout << "D";
    }
    for (int i = 1; i <= m - reqy - 1; i++)
    {
        cout << "R";
    }
    cout << endl;
