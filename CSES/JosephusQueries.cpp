...
void solve()
{
   ...
   cout<<toBinary(14)<<endl;
   cout<<toBinary(16)<<endl;
   cout<<toBinary(18)<<endl;
   cout<<toBinary(20)<<endl;
   cout<<toBinary(22)<<endl;
   cout<<toBinary(24)<<endl;
   cout<<toBinary(1)<<endl;
   cout<<toBinary(5)<<endl;
   cout<<toBinary(9)<<endl;
   cout<<toBinary(13)<<endl;
   cout<<toBinary(17)<<endl;
   cout<<toBinary(21)<<endl;
   cout<<toBinary(25)<<endl;
   cout<<toBinary(7)<<endl;
   cout<<toBinary(15)<<endl;
   cout<<toBinary(23)<<endl;
   cout<<toBinary(11)<<endl;
   cout<<toBinary(3)<<endl;
   cout<<toBinary(19)<<endl;
}
