...
void solve()
{
    ...
    // Instead of finding the number of subarrays with k distinct elements we would find the
    // number of subarrays with atmost k and k-1 distinct elements and then would simple subtract the ans
    int cntk = 0, cntkmo = 0;
    for (int i = 0; i < n; i++)
    {
        map<int, int> freq;
